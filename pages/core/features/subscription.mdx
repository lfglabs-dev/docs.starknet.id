...
1/ Go to your identity page & click on "enable subscription" button

![img](public/illustrations/id-page-enable.webp)

2/ Select the domain to renew & click on "enable subscription"

![img](public/illustrations/domain-renew-enable.webp)

3/ The enable subscription feature has been activated
...
![img](public/illustrations/id-page-disable.webp)

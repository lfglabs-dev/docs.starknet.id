...
Starknetid.go is a Go library to interact with the Starknet ID protocol developed and maintained by [Metacube games](https://github.com/metacube-games). The implementation is inspired by the official Javascript library [Starknetid.js](https://github.com/starknet-id/starknetid.js).

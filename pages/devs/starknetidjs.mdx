...
**Please note**: Version 2.0.0 of `starknetid.js` were compatible with an old version of the contract (Cairo 0). To support last version please upgrade to `starknetid.js@3.0.0`.

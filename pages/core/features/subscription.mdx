...
![img](public/illustrations/enable-subscription.webp)
...
The Subscription smart-contracts have been audited by independent third-party security firms to ensure user security. You can take a look on the [Audits](https://github.com/lfglabs-dev/auto_renew_contract/tree/main/audits) section.